    ...
    var page = {
        ...
        fnGetList: function (data, initPage) {
            ...
            var oTr,
                ...
                controlTd =
                    "<td><a class='text-blue' href='/clientManage/clientListView/buyLog?id=123'>查看</a></td>" +
                    "<td><a class='J_showChangeLine text-yellow' href='javascript:;'>修改额度</a></td>" +
                    "<td><a class='J_showStopTrade text-red' href='javascript:;'>停止交易</a></td>";
